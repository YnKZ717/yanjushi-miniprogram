const ROOMS = [
  {
    ...
    tags: ['私汤', '山景', '颜料名'],
    color: '#3A5A7C',
    cover: '/assets/rooms/shiqing.jpg',
    images: [],
  ...
  },
  {
    ...
    tags: ['观星天窗', '家庭友好', '颜料名'],
    color: '#6B8E4E',
    cover: '/assets/rooms/chunchen.jpg',
    images: [],
...
const ACTIVITIES = [
  {
    ...
    color: '#C44536',
    icon: '🔥',
    cover: '/assets/activities/kiln.jpg',
  ...
  },
  {
    ...
    color: '#4D7C4F',
    icon: '🪨',
    cover: '/assets/activities/stone.jpg',
  ...
  },
  {
    ...
    color: '#A67C52',
    icon: '👾',
    cover: '/assets/activities/adopt.jpg',
  ...
  },
  {
    ...
    color: '#C9A961',
    icon: '🏺',
    cover: '/assets/activities/chai.jpg',
  ...
  },
  {
    ...
    color: '#6B4E71',
    icon: '🎨',
    cover: '/assets/activities/improvise.jpg',
...
const EXPERIENCES = [
  {
    ...
    tags: ['零基础友好'],
    icon: '🖐️',
    cover: '/assets/experiences/hand.jpg',
  ...
  },
  {
    ...
    tags: ['含1件作品烧制'],
    icon: '🏺',
    cover: '/assets/experiences/wheel.jpg',
  ...
  },
  {
    ...
    tags: ['每日供应'],
    icon: '🍵',
    cover: '/assets/experiences/tea.jpg',
...
const MALL_PRODUCTS = [
  {
    ...
    price: 68,
    tags: ['一套8张'],
    cover: '/assets/mall/postcard.jpg',
...
function getProductById(id) {
  return MALL_PRODUCTS.find(p => p.id === id)
}
