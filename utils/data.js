const ROOMS = [
  {
    ...
    tags: ['私汤', '山景', '颜料名'],
    color: '#3A5A7C',
    cover: 'https://cdn.jsdelivr.net/gh/YnKZ717/yanjushi-miniprogram@master/pics/rooms/shiqing.png',
    images: [],
  ...
  },
  {
    ...
    tags: ['观星天窗', '家庭友好', '颜料名'],
    color: '#6B8E4E',
    cover: 'https://cdn.jsdelivr.net/gh/YnKZ717/yanjushi-miniprogram@master/pics/rooms/chunchen.png',
    images: [],
  ...
  },
  {
    ...
    tags: ['独栋木屋', '私汤', '情侣首选'],
    color: '#A67C52',
    cover: 'https://cdn.jsdelivr.net/gh/YnKZ717/yanjushi-miniprogram@master/pics/rooms/zheshi.png',
    images: [],
...
const ACTIVITIES = [
  {
    ...
    tags: ['限8席', '16岁以上', '每季限定'],
    color: '#C44536',
    cover: 'https://cdn.jsdelivr.net/gh/YnKZ717/yanjushi-miniprogram@master/pics/activities/kiln.png',
  ...
  },
  {
    ...
    color: '#4D7C4F',
    cover: 'https://cdn.jsdelivr.net/gh/YnKZ717/yanjushi-miniprogram@master/pics/activities/stone.png',
  ...
  },
  {
    ...
    tags: ['深度课', '主理人亲授'],
    color: '#C9A961',
    cover: 'https://cdn.jsdelivr.net/gh/YnKZ717/yanjushi-miniprogram@master/pics/activities/chai.png',
  ...
  },
  {
    ...
    tags: ['艺术家亲授', '限额4人'],
    color: '#6B4E71',
    cover: 'https://cdn.jsdelivr.net/gh/YnKZ717/yanjushi-miniprogram@master/pics/activities/improvise.png',
...
const EXPERIENCES = [
  {
    ...
    tags: ['零基础友好'],
    color: '#A67C52',
    cover: 'https://cdn.jsdelivr.net/gh/YnKZ717/yanjushi-miniprogram@master/pics/experiences/hand.png',
  ...
  },
  {
    ...
    tags: ['含1件作品烧制'],
    color: '#C9A961',
    cover: 'https://cdn.jsdelivr.net/gh/YnKZ717/yanjushi-miniprogram@master/pics/experiences/wheel.png',
  ...
  },
  {
    ...
    tags: ['每日供应'],
    color: '#6B8E4E',
    cover: 'https://cdn.jsdelivr.net/gh/YnKZ717/yanjushi-miniprogram@master/pics/experiences/tea.png',
